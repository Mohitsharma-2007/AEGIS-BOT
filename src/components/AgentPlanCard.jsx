  ...
  return (
    <div className="bg-aegis-panel rounded-xl border border-aegis-border p-3.5 space-y-3 shadow-sm select-none">
      <div className="flex items-center justify-between border-b border-aegis-border/80 pb-2">
        ...
        <span className="text-[9px] font-mono text-aegis-text-muted px-1.5 py-0.2 rounded bg-white/[0.04] border border-white/5">
      ...
      {task && (
        <div className="bg-aegis-card p-2.5 rounded-lg border border-white/[0.04]">
          <span className="text-[9px] uppercase font-mono text-cyan-400/80 block mb-0.5 tracking-wider">
            Active Objective
          </span>
              ...
              >
                <div className="mt-0.5 shrink-0">
                  {isCompleted ? (
                    ...
                    <div className="w-3.5 h-3.5 rounded-full bg-cyan-400/20 border border-cyan-400 flex items-center justify-center">
                ...
                <div className="min-w-0 flex-1">
                  <span className={`block leading-tight text-xs font-sans ${
                    isCompleted 
